...
class MerchandisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchandise" do
    assert_difference('Merchandise.count') do
      post merchandises_url, params: { merchandise: { details: @merchandise.details, name: @merchandise.name, price: @merchandise.price } }
    end
  ...
  test "should update merchandise" do
    patch merchandise_url(@merchandise), params: { merchandise: { details: @merchandise.details, name: @merchandise.name, price: @merchandise.price } }
