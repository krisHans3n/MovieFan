...
class LineitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post lineitems_url, params: { lineitem: { carts_id: @lineitem.carts_id, merchandises_id: @lineitem.merchandises_id } }
    end
  ...
  test "should update lineitem" do
    patch lineitem_url(@lineitem), params: { lineitem: { carts_id: @lineitem.carts_id, merchandises_id: @lineitem.merchandises_id } }
