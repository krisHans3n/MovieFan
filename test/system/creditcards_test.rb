...
class CreditcardsTest < ApplicationSystemTestCase
  ...
  test "creating a Creditcard" do
    ...
    fill_in "Expdate", with: @creditcard.expdate
    fill_in "Nameoncard", with: @creditcard.nameoncard
    fill_in "Number", with: @creditcard.number
    fill_in "Organisationtype", with: @creditcard.organisationtype
    fill_in "Users", with: @creditcard.users_id
